...
test('update data', function (){
    ...
    Stack.put(3,'my secret number','nooverwrite');
...
test('saving point withou label and restore it without parameter', function (){
    ...
    equals(Stack.size(),5,'The last point is now official');
});
